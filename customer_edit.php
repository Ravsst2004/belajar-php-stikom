...
$id = $_GET['customer_id'];
// Mengambil data
$customer = $Customer->getCustomers("SELECT * FROM customers WHERE customer_id = $id")[0];

// Cek jika tombol submit ditekan untuk mengeksekusi query edit
if (isset($_POST['submit'])) {
  if ($Customer->updateCustomers($_POST)) {
    echo "
            <script>
